...
void make_h_dash(QWORD h)
{
	...
	h2 = (h & (0xFC00000000000000 >> 6)) >> (64 - 8 * 2));
	h3 = (h & (0xFC00000000000000 >> 12)) >> (64 - 8 * 3);
	h4 = (h & (0xFC00000000000000 >> 18)) >> 64 - 8 * 4;
	h5 = (h & (0xFC00000000000000 >> 24)) >> 64 - 8 * 5;
	h6 = (h & (0xFC00000000000000 >> 30)) >> 64 - 8 * 6;
	h7 = (h & (0xFC00000000000000 >> 36)) >> 64 - 8 * 7;
	h8 = (h & (0xFC00000000000000 >> 32)) >> 64 - 8 * 8;
...
void ecb_cipher(BYTE* plain_text)
{
	...
	make_e(make_e_test);
	//QWORD H = x ^ k;
	QWORD h_dash_test = 0x00FC000000000000;
